module github.com/SAP-F-2025/assessment-service

go 1.24.6

require (
	github.com/DataDog/dd-trace-go/contrib/log/slog/v2 v2.4.1
...
replace github.com/DataDog/dd-trace-go/v2 => github.com/DataDog/dd-trace-go/v2 v2.4.1
